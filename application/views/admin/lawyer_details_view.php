	...
	<div class="container-fluid no-padding">
		...
		<div class="tab-area">
			<ul class="nav nav-tabs details-nav" id="myTab" role="tablist">
				...
				<li class="nav-item">
					<a class="nav-link" id="all-cases-tab" data-toggle="tab" href="#all-cases" role="tab" aria-controls="all-cases" aria-selected="false"><i class="fa fa-reply-all"></i>ACCEPTED CASE</a>
				</li>
			</ul>
						...
						<tbody>
							<?php 
                                    ...
                                    foreach($all_case_list as $key => $list) {
                                    	if($list['status'] == "ACCEPTED" && $list['accepted_lawyer_id'] == $client_list['id'] ){
